...
export const metadata: Metadata = {
  title: "Nitin Auto Xerox & Stationery | Printing in Bhavnagar",  description: "Fast, reliable xerox, printing, and stationery services in Bhavnagar. T-shirt printing, civil maps, and custom designs. Open daily until 9:30 PM.",  keywords: "xerox, printing, stationery, Bhavnagar, t-shirt printing, photocopying, civil maps",  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Nitin Auto Xerox & Stationery - Quality Printing Services",    description: "Professional xerox, printing, and stationery services in Bhavnagar. Quick turnaround, affordable pricing.",    url: "https://nitinauto.local",    siteName: "Nitin Auto Xerox & Stationery",    type: "website"},
  twitter: {
    card: "summary",    title: "Nitin Auto Xerox & Stationery",    description: "Fast, reliable printing and xerox services in Bhavnagar"},
};
